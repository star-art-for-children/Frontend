...
const BUNNY_PATH = '/GLBformat/character/bunny.glb';
const Y_OFFSET = 0;
const FADE_DURATION = 0.2;

type ActionName = 'Running' | 'Walking';

type BunnyGLTFResult = GLTF & {
...
export default function BunnyCharacter() {
  ...
  const { nodes, materials } = useGraph(clone) as unknown as BunnyGLTFResult;
